...
export function TopActionButtons({ onOpenExcel, onOpenPerson, onSaveVersion, onOpenVersions, onExport, onFullReoptimize, onNearbyServices, onLogout }: TopActionButtonsProps) {
  return (
